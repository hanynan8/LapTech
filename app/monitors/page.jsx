...
const MonitorsPage = () => {
  ...
  // تحميل البيانات من الـ API المزوَّد (collection=monitors)
  useEffect(() => {
    ...
    if (searchQuery.trim()) {
      filtered = filtered.filter(product =>
        ...
        (product.specs && Object.values(product.specs).some(spec => 
          typeof spec === 'string' && spec.toLowerCase().includes(searchQuery.toLowerCase())
        )) ||
    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center" dir="rtl">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600">جاري تحميل الشاشات...</p>
        </div>
      </div>
    );
  }
  ...
  if (!data) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        <div className="text-center">
          <p className="text-red-500 text-xl mb-4">خطأ في تحميل بيانات الشاشات</p>
          <button 
    ...
    <div className="min-h-screen bg-slate-50" dir="rtl">
                    ...
                    <div className="p-6">
                      ...
                      {product.specs && (
                        <div className="space-y-2 text-sm text-gray-600 mb-4">
                          <div className="flex justify-between">
                            <span>المقاس:</span>
                            <span className="font-medium text-purple-600">{product.specs.size}</span>
                          </div>
                          <div className="flex justify-between">
                            <span>الدقة:</span>
                            <span className="font-medium text-purple-600">{product.specs.resolution}</span>
                          </div>
                          <div className="flex justify-between">
                            <span>معدل التحديث:</span>
                            <span className="font-medium">{product.specs.refreshRate}</span>
                          </div>
                          <div className="flex justify-between">
                            <span>اللوحة:</span>
                            <span className="font-medium">{product.specs.panel}</span>
                          </div>
                        </div>
                      )}
                      ...
                      {/* {product.benchmarks && (
                        <div className="bg-gray-50 rounded-2xl p-3 mb-4">
                          <h4 className="text-sm font-bold text-gray-800 mb-2">معايير الأداء:</h4>
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-blue-600 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center text-white">
          ...
          <p className="text-xl mb-8 opacity-90">اخبرنا عن الاستخدام والحجم المطلوب وسنقترح أفضل الشاشات المناسبة لاحتياجاتك</p>
