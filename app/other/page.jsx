...
const OtherProductsPage = () => {
  ...
  // تحميل البيانات من الـ API المزوَّد (collection=other-products)
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        console.error('خطأ في جلب بيانات المنتجات من الـ API:', error);
        setData(null);
        setFilteredProducts([]);
      } finally {
        setLoading(false);
                    ...
                    <div className="bg-white rounded-3xl overflow-hidden shadow-lg group-hover:shadow-2xl transform group-hover:scale-105 transition-all duration-500">
                      ...
                      <div className="p-6">
                        ...
                        <div className="bg-gray-50 rounded-2xl p-3 mb-4">
                          <h4 className="text-sm font-bold text-gray-800 mb-2">مؤشرات الأداء:</h4>
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-blue-600 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center text-white">
          ...
          <p className="text-xl mb-8 opacity-90">
            اخبرنا عن الاستخدام والميزانية وسنقترح أفضل المنتجات والحزم المناسبة
            مع دعم كامل
          </p>
...
/*
  --- JSON sample for collection `other-products` (paste into your backend) ---
  The payload below is an array with a single object, matching the structure used by the page.
  It includes pageTitle, pageSubtitle, categories, filters and 20 products.

  (Put this JSON into the collection named: other-products)
*/
