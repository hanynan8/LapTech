...
const PCBuildsPage = () => {
  ...
  // تحميل البيانات من الـ API المزوَّد
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        // الـ API بيرجع مصفوفة تحتوي على كائن واحد — لو كانت مصفوفة خذ العنصر الأول، وإلا خذ json كما هو
    ...
    return (
      ...
      >
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600">جاري تحميل التجميعات...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-6 items-center justify-between">
            ...
            <div className="text-gray-600">
              عرض {filteredProducts.length} من {data.products.length} تجميعة
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-blue-600 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center text-white">
          ...
          <p className="text-xl mb-8 opacity-90">
            دعنا نصمم لك التجميعة المثالية حسب احتياجاتك وميزانيتك مع ضمان
            التوافق الكامل
          </p>
