...
const POSPage = () => {
  ...
  // تحميل البيانات من الـ API (collection=pos)
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        console.error('خطأ في جلب بيانات نقاط البيع من الـ API:', error);
        setData(null);
        setFilteredProducts([]);
      } finally {
        setLoading(false);
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        <div className="text-center">
          <p className="text-red-500 text-xl mb-4">
            خطأ في تحميل بيانات نقاط البيع
          </p>
          <button
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-6 items-center justify-between">
            ...
            <div className="text-gray-600">
              عرض {filteredProducts.length} من {data.products.length} نظام
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-blue-600 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center text-white">
          ...
          <p className="text-xl mb-8 opacity-90">
            اخبرنا نوع النشاط والحجم وسنقترح أفضل الحلول مع إعداد ودعم فني
          </p>
